...
static int ifft=0;
static void (*iAnimFunction[10])(void)={0};
...
void iInitialize(int width, int height, char const * title) {
  ...
  glutSpecialUpFunc(keyboardUpHandlerFF);
